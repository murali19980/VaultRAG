    ...
    <div className="flex items-center justify-between p-3 bg-gray-50 hover:bg-gray-100/70 dark:bg-gray-800/40 dark:hover:bg-gray-800/80 rounded-xl border border-gray-100 dark:border-gray-800/80 transition-all">
      <div className="flex items-center gap-3 overflow-hidden flex-1">
        ...
        <div className="flex-1 min-w-0">
          <p 
            onClick={() => onPreview && onPreview(fileName)}
            className={`text-xs font-semibold text-gray-900 dark:text-gray-100 truncate ${onPreview ? "cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 hover:underline" : ""}`}
            title={fileName}
          >
            {fileName}
          </p>
      ...
      <div className="flex items-center gap-1">
        {onPreview && !showConfirm && (
          <button
            onClick={() => onPreview(fileName)}
            className="p-1.5 text-gray-400 hover:text-blue-600 dark:text-gray-500 dark:hover:text-blue-400 rounded-lg transition flex-shrink-0"
